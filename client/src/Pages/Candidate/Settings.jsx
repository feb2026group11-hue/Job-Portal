              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <FormControlLabel
                    ...
                    label="Email Alerts (Receive notifications for new jobs, status updates, messages)"
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <FormControlLabel
                    ...
                    label="Job Recommendations (Receive weekly emails matching your skills profile)"
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <FormControlLabel
                    ...
                    label="Application Status Changes (Get alerted when employers view/update applications)"
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <FormControlLabel
                    ...
                    label="SMS Alerts (Receive text updates for critical messages)"
                  />
                </Grid>
              </Grid>
            </Paper>
