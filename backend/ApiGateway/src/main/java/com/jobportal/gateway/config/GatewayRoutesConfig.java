        ...
        public RouteLocator routeLocator(RouteLocatorBuilder builder) {
                return builder.routes()
                                ...
                                .route("auth-service", r -> r
                                                .path("/api/auth", "/api/auth/**", "/api/users", "/api/users/**",
                                                                "/user", "/user/**")
                                                .uri("lb://SECURITY5"))
                                // Candidate Profile Service (candidate-profile-service)
                                .route("candidate-profile-service", r -> r
                                                .path("/api/profile", "/api/profile/**", "/api/companies",
                                                                "/api/companies/**",
                                                                "/api/skills", "/api/skills/**",
                                                                "/api/candidate-skills", "/api/candidate-skills/**",
                                                                "/api/projects", "/api/projects/**",
                                                                "/api/certificates", "/api/certificates/**",
                                                                "/api/candidate/resume", "/api/candidate/resume/**",
                                                                "/api/candidate/me", "/api/candidate/me/**",
                                                                "/candidate-profile", "/candidate-profile/**",
                                                                "/education", "/education/**", "/api/experiences",
                                                                "/api/candidate/me/save-parsed-profile",
                                                                "/api/candidate/me/save-parsed-profile/**",
                                                                "/api/experiences/**")
                                ...
                                .route("job-application-service", r -> r
                                                .path("/api/jobs", "/api/jobs/**", "/api/applications",
                                                                "/api/applications/**",
                                                                "/api/job-status", "/api/job-status/**",
                                                                "/api/messages", "/api/messages/**",
                                                                "/api/states", "/api/states/**", "/api/cities",
                                                                "/api/cities/**")
